...
UUID=${UUID:-'8740e797-111b-4e80-85e2-ad139e4e7cac'}
VMESS_WSPATH=${VMESS_WSPATH:-'/8740e797-111b-4e80-85e2-ad139e4e7cac-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/8740e797-111b-4e80-85e2-ad139e4e7cac-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/8740e797-111b-4e80-85e2-ad139e4e7cac-trojan'}
SS_WSPATH=${SS_WSPATH:-'/8740e797-111b-4e80-85e2-ad139e4e7cac-shadowsocks'}
